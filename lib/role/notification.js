...
function sendNotification(tokens,title,content,callback) {
...
function sendNotificationByUserId(userId,title,content,callback){
    const queryInfo = {
    ...
    getNotificationList(queryInfo,0,99999,{},(result,data)=>{
        if(result === true){
            ...
            sendNotification(tokens,title,content,callback)
        }else{
