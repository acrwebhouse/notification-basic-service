...
function sendApnsNotification(tokens,title,content,type,prop,callback) {
    ...
    console.log('======sendApnsNotification===tokens====',tokens)
    console.log('======sendApnsNotification===apnsNotification====',apnsNotification)
    console.log('======sendApnsNotification===prop====',prop)
    console.log('======sendApnsNotification===prop==json==',JSON.stringify(prop))
    if(utilsValue.isValid(prop)){
        for( let key in prop){
            apnsNotification.alert[key] = prop[key]
        }
    }
